...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Portland_live} \label{fig:enlighten}
...
Mehr High-Tech, aber auch umfangreichere Funktionen bietet der vom amerikanischen Startup \textsc{Helios-Bikes} entwickelte \textsc{Helios}-Lenker. 
\begin{figure}[H]
    \centering
