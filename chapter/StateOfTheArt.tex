...
Ampelassistenten als mobile Anwendung sind recht einfach umzusetzen. \glspl{Smartphone} sind bereits mit einem \gls{GPS}-Empfänger ausgestattet und haben fast durchgängig Internetzugang. Die hier vorgestellten mobilen Anwendungen existieren bereits oder befinden sich in der Testphase.
%%% ENLIGHTEN %%%
