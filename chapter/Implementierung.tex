...
\begin{center}
\rule{35em}{0.5pt}
\lstinputlisting[language=Java, firstline=50, lastline=53, caption={onLocationChanged() in GpsTracker.java}, label=lst:gps1]{code/gpstracker.java}
\rule{35em}{0.5pt}
\end{center}
...
\begin{center}
\rule{35em}{0.5pt}
\lstinputlisting[language=Java, firstline=8, lastline=48, caption={getNearestLSA() GpsTracker.java}, label=lst:gps]{code/gpstracker.java}
\rule{35em}{0.5pt}
\end{center}
