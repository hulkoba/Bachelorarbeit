...
Letzteres ist auf "'8"' gesetzt und zeigt, dass die Anwendung auf Mobilgeräten auf denen mindestens die Android-Version 2.2 installiert sein muss. 
Die Android-Version wurde auf 2.2 festgelegt, da damit sämtliche Geräte, die auf den Google-Play-Store zugreifen können, abgedeckt sind. \cite{android_version} 
%
% MainActivity
%
\clearpage
...
\begin{center}
%\rule{35em}{0.5pt}
\lstinputlisting[language=Java, firstline=13, lastline=69, caption={getNearestLSA() GpsTracker.java}, label=lst:gps]{code/gpstracker.java}
\rule{35em}{0.5pt}
\end{center}
%
% v = s/t
