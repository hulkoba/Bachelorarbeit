...
\begin{center}
\rule{35em}{0.5pt}
\lstinputlisting[language=Java, firstline=1, lastline=4, caption={onLocationChanged() in GpsTracker.java}, label=lst:gps1]{code/gpstracker.java}
\rule{35em}{0.5pt}
\end{center}
...
\begin{center}
\rule{35em}{0.5pt}
\lstinputlisting[language=Java, firstline=13, lastline=51, caption={getNearestLSA() GpsTracker.java}, label=lst:gps]{code/gpstracker.java}
\rule{35em}{0.5pt}
\end{center}
%
% v = s/t
