...
\subsubsection{Geolokation mittels Netzwerk}
...
Ähnlich der \gls{WLAN}-basierten Standorterkennung funktioniert die funkzellenbastierte. Das Mobilgerät muss mit einem Funkturm in Verbindung stehen. Bewegt sich das Gerät, verbindet es sich mit einem anderen Turm und die Signalstärke des sich nähernden Turms wird stärker. Unter Kenntnis der einzigartigen ID und der Position des Turms mit dem das Gerät verbunden ist und ggf. der Türme, mit denen das Gerät zuletzt verbunden war, lässt sich der eigene Standort ermitteln. (\cite{location} S. 8f) \\
\textbf{Triangulation??? Google || Android location service??}\\
