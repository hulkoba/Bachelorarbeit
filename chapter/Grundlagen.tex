...
Inzwischen wird auf etlichen Mobiltelefonen zusätzlich das russische \gls{GNSS} names \glstext{GLONASS}\footnote{ GLONASS, russisch Globalnaja nawigazionnaja sputnikowaja sistema, dt. Globales Satellitennavigationssystem} eingesetzt\footnote{ \url{http://en.wikipedia.org/wiki/List_of_smartphones_supporting_GLONASS_navigation}}.
