...
Das Globale Positionsbestimmungssystem umfasst 27 Satelliten die ständig die Erde umkreisen und dabei kontinuierlich ihre eigene, aktuelle Position und Almanach-Daten aussenden. Almanach-Daten enthalten Daten über jeden Satelliten in der Konstellation. Abbildung \ref{fig:gps} zeigt eine Darstellung der GPS-Satellitenkonstellation. Jeder Satellit folgt einer definierten Bahn, sodass mindestens vier Satteliten von jedem Standpunkt auf der Erde aus "'sichtbar"' sind. (\cite{location} S. 4f)
\begin{figure}[H]  
    \centering  
    \includegraphics[width=0.4\textwidth]{gps} 
    \caption[GPS Satelliten Konstellation]{GPS Satelliten Konstellation  Quelle: \url{http://www.gps.gov/multimedia/images/constellation.jpg}}
    \label{fig:gps}
\end{figure}
