...
% SQLITE
\subsection{SQLite}
SQLite ist eine eingebettete Datenbank-Engine die auch bei Android sehr beliebt ist. Der Code ist Open Source und frei für den privaten oder gewerblichen Einsatz.\\
