...
Unter dem Prinzip "'Grüne Welle'" ist die Abstimmung der Ampelschaltzustände, sodass ein Fahrzeug in einer bestimmten Geschwindigkeit mehrere Ampeln passieren kann ohne anzuhalten zu verstehen.
Der folgende Abschnitt soll die existierenden Lösungen und Ansätze für die Empfehlung von Geschwindigkeiten an Lichtsignalanlagen darstellen.
