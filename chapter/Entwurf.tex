...
\centering
	...
	\label{fig:plan}	
\end{figure}
In dem oben gezeigtem Beispiel steht demnach die Ampel R1 zwischen 11 und 17 Uhr in jeder Minute für die Sekunden 12 - 30 auf Grün und den Rest der Zeit auf Rot.\\\\
%\begin{figure}[H]  
%    \centering  
...
Als Referenzzeit ist die Zeit zwischen 12 und 16 Uhr von Freitag bis Montag gewählt. Diese kann selbstverständlich bei Bedarf ausgedehnt, bzw. vervollständigt werden.
%
% LSA als JSON
%
