...
Wie bereits erwähnt ist einer der Nachteile von \gls{GPS} auf mobilen Geräten der hohe Stromverbrauch. Eine Lösung hierfür bietet die Verwendung eines externen \gls{GPS}-Geräts, das über Bluetooth mit dem \gls{Smartphone} verbunden ist. Das verbessert die Akkulaufzeit und außerdem ist die Qualität des \gls{GPS}-Empfängers höher als die des im \gls{Smartphone} verbauten und kann somit eine präziesere Ortung erlangen. (Vgl. \cite{gps} S. 28) \\ Der Nachteil hierbei ist die Notwendigkeit eines zweiten Gerätes.
% ### Achitektur ###
\section{Architektur}
