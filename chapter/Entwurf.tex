...
\begin{table}[H]
	...
	\begin{tabular}{@{}cc@{}}
		...
		\multicolumn{2}{l}{\cellcolor[HTML]{ECF4FF}\textsc{\centering \large Kreuzung}}                                                                  \\ \midrule
